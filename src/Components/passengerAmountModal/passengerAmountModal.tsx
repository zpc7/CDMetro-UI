...
const PassengerAmountModal = ({ visible, editRecord, lineConfig, onCancel, onOk }: Props) => {
  ...
  return (
    ...
    >
      <Form form={form} onFinish={handleFinish} initialValues={{ date: moment().subtract(1, 'days'), dateType: 'NWD' }}>
        <Form.Item
          name="date"
          label="客运日期"
          wrapperCol={{ span: 6 }}
